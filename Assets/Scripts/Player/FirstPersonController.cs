...
public class FirstPersonController : NetworkBehaviour
{
    ...
    private CommandAndControlManager ccManger;
    ...
    void Start()
    {
        ...
        if (IsHost)
        {
            //GetComponentInChildren<Camera>().cullingMask = LayerMask.GetMask("Default", "TransparentFX", "Ignore Raycast", "Water", "UI", "Player");
        }
